...
declare global {
  ...
  const cachedEventHandler: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useQuery: typeof import('h3')['useQuery']
  const useRawBody: typeof import('h3')['useRawBody']
  const useRuntimeConfig: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useStorage: typeof import('/workspaces/api-pxflux-xyz/node_modules/nitropack/dist/runtime')['useStorage']
